...
class FaqsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faq" do
    assert_difference("Faq.count") do
      post faqs_url, params: { faq: { body: @faq.body, icon: @faq.icon, slug: @faq.slug, title: @faq.title } }
    end
  ...
  test "should update faq" do
    patch faq_url(@faq), params: { faq: { body: @faq.body, icon: @faq.icon, slug: @faq.slug, title: @faq.title } }
