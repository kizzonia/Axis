...
class HelpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create help" do
    assert_difference("Help.count") do
      post helps_url, params: { help: { body: @help.body, slug: @help.slug, sub_title: @help.sub_title, title: @help.title } }
    end
  ...
  test "should update help" do
    patch help_url(@help), params: { help: { body: @help.body, slug: @help.slug, sub_title: @help.sub_title, title: @help.title } }
