...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference("Support.count") do
      post supports_url, params: { support: { body: @support.body, help_id: @support.help_id, sub_title: @support.sub_title, title: @support.title } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { body: @support.body, help_id: @support.help_id, sub_title: @support.sub_title, title: @support.title } }
